...
<body>
	<div id="part2Header" class="header">
		...
		<div id="headerTabs">
			<a href="/DataWarehouse/part1"><button id="part1">Part2</button></a>
			<a><button id="part2" class="active">Part3</button></a>
		</div>
		<div>
			<div id="headerLeft">
	...
	<div id="part2Content" class="content">
		...
		<ul id="tabs">
			<li id="tab-7" style="width: 48%;">Query 1</li>
			<li id="tab-8" style="width: 48%;">Query 2</li>
		</ul>
		<div id="query7" class="page">
			<div class='queryDetails'>
				...
				<button id="q7Run" data-rid="Q7" data-type="query" class='runButton'>RUN</button>
			</div>
		...
		<div id="query8" class="page">
			<div class='queryDetails'>
				...
				<button id="q8Run" data-rid="Q8" data-type="query" class='runButton'>RUN</button>
			</div>
