...
<body>
	<div id="part1Header" class="header">
		...
		<div id="headerTabs">
			<a><button id="part1" class="active">Part2</button></a>
			<a href="/DataWarehouse/part2"><button id="part2">Part3</button></a>
		</div>
		<div>
			<div id="headerLeft">
	...
	<div id="part1Content" class="content">
		...
		<div id="query1" class="page">
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 1: List the number of patients who had 'tumor' (disease description), 'leukemia' (disease type) and 
		...
		<!-- <div> -->
				...
				<button id="q1Run" data-rid="Q1" class='runButton'>RUN</button>
			</div>
		...
		<div id="query2" class="page" >
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 2: List the types of drugs which have been applied to patients with 'tumor'.</h3>
				Disease Description:
				<select id="optionSelectQ2" data-key="Q2">
					<option selected value="NA">Select</option>
				</select>
				<button id="q2Run" data-rid="Q2" data-type="query" class='runButton'>RUN</button>
			</div>
			<div id="resultQ2" class="result"></div>
		</div>
		<div id="query3" class="page">
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 3: For each sample of  patients with 'ALL' list the mRNA values (expression) of probes in cluster 
				...
				<button id="q3Run" data-rid="Q3" data-type="query" class='runButton'>RUN</button>
			</div>
			<div id="resultQ3" class="result"></div>
		</div>
		<div id="query4" class="page">
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 4: For probes belonging to GO with id = '0012502', calculate the t-statistics of the expression 
				...
				<button id="q4Run" data-rid="Q4" data-type="query" class='runButton'>RUN</button>
			</div>
			<div id="resultQ4" class="result"></div>
		</div>
		<div id="query5" class="page">
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 5: For probes belonging to GO with id='0007154', calculate the F-statistics of the expression 
				...
				<button id="q5Run" data-rid="Q5" data-type="query" class='runButton'>RUN</button>
			</div>
			<div id="resultQ5" class="result"></div>
		</div>
		<div id="query6" class="page">
			<div class='queryDetails'>
				<h3 class='queryStmt'> Query 6: For probes belonging to GO with id='0007154', calculate the average correlation of the 
				...
				<button id="q6Run" data-rid="Q6" data-type="query" class='runButton'>RUN</button>
			</div>
