...
public class WarehouseController {
	...
	public String fetchResult(@RequestBody String input){
		...
		if( !result.contains("ul") ){
			return "<div class='onlyRs'>Number of rows selected: "+result+"<div>";
		}
		else{
			return result;
		}
	...
	public String fetchResultQ4(@RequestBody String input){
		...
		String rs = "<div class='onlyRs'>T-Stat value: "+String.valueOf(Util.calculateTTest(resultSet1, resultSet2))+"<div>";
	...
	public String fetchResultQ5(@RequestBody String input){
		...
		String rs = "<div class='onlyRs'>F-Statistic value: "
				+String.valueOf(Util.calculateFStatistics(resultSet1, resultSet2 , resultSet3 , resultSet4))+"<div>";
	...
	public String fetchResultQ6(@RequestBody String input){
		...
		String rs = "<center><ul style='font-size:20px;'><li>Average correlation for ALL - ALL : "+avgCorr1 + "</li>"
	...
	public String fetchResultQ7(@RequestBody String input){
		...
		builder.append("<div class='rsSum'>Number of informative genes found: "+result.size()+"</div>");
		
		if( result.size() > 0 ){
			builder.append("<center><ul><li class='head'><ul><li>U-ID</li></ul></li>");
		}
	...
	public String fetchResultQ8(@RequestBody String input){
		...
		if( result.size() > 1 ){
			...
			rsBuilder.append("</ul></center>");
		}
		else{
			rsBuilder.append("<div class='rsSum'>No informative genes found</div>");
		}
