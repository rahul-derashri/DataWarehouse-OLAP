...
public class DataService {
	...
	public String queryForResultCount(String queryType, String dataType){
		//if( this.template == null ){
			...
			this.template.setFetchSize(10000);
		//}
		//this.template = new JdbcTemplate(this.dataSource);
	...
	public String queryForResult(String queryType, String dataOption){
		...
		String result = processTabularData(template.queryForList(queryString) , queryType);
	...
	private String processTabularData(List<Map<String, Object>> data, String queryType){
		
		StringBuilder builder = new StringBuilder();
		
		switch (queryType) {
			case "Q2":
				builder.append("<div class='rsSum'>Result: "+data.size()+" rows selected </div>");
				builder.append("<center><ul><li class='head'><ul><li>Drug Types</li></ul></li>");
				break;
			case "Q3":
				builder.append("<div class='rsSum'>Result: "+data.size()+" rows selected </div>");
				builder.append("<center><ul><li class='head'><ul><li>S-ID</li><li>Exp. Values</li></ul></li>");
				break;
			default:
				builder.append("<ul>");	
				break;
